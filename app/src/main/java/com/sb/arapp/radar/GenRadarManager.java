...
public class
GenRadarManager implements SensorEventListener {
	...
	public void initRadarlayout() {
		...
		Log.e("VF","GenRad: "+mRadarPoints.size());
		mRadarSprite = new GenRadarSprite(mContext, mRadarPoints,MAP_WIDTH);
	...
	public synchronized void updateRadarWithPoints(List<GenRadarPoint> genRadarPoints){
		...
		Log.e("VF","GenRad 2: "+genRadarPoints.size());
		...
		Log.e("VF","GenRad final points: "+finalPointsToDraw.size());
	...
	private List<GenRadarPoint> applyCenterTransformation() {
		...
		Log.d("MAP WIDTH/HEIGHT ", MAP_WIDTH+ " , "+MAP_HEIGHT);
